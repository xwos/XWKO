...
#define ARCH_HAVE_UCHAR         1
typedef unchar uchar;

#define ARCH_HAVE_USHORT        1 /* linux has the type ushort. */
#define ARCH_HAVE_UINT          1 /* linux has the type uint. */
#define ARCH_HAVE_ULONG         1 /* linux has the type ulong. */

#define ARCH_HAVE_LONGLONG      1
typedef long long longlong;

#define ARCH_HAVE_ULONGLONG     1
...
#define ARCH_HAVE_XWLFQ_T       1
typedef unsigned __int128 xwlfq_t; /**< 无锁队列 (无符号) */
