 ...
 */
__xwlib_data xwsq_a xwos_objtik_dispatcher;
...
void xwos_objtik_init(void)
{
        ...
        xwos_objtik_dispatcher = (cpunum * XWOS_OBJTIK_CHUNK);
	for_each_online_cpu(i) {
                per_cpu(xwos_objtik, i) = (i * XWOS_OBJTIK_CHUNK);
        }
}
...
xwsq_t xwos_objtik_get(void)
{
        ...
        cpu = xwos_skd_id_lc();
        objtik = (xwsq_a *)&get_cpu_var(xwos_objtik);
        while (true) {
